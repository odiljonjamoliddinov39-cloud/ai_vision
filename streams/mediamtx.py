...
class MediaMTXClient:
    ...
    def ensure_source(self, channel_id: str, upstream_url: str) -> MediaRoute:
        ...
        payload = {
            ...
            "record": True,
            # MediaMTX 1.19 requires the %path variable in every per-path
            # recording template. The generated path already contains the
            # stable camera id (camera-<id>-source), preserving camera/date/time
            # storage without duplicating the id here.
